...
namespace SmartContractsGenerator.Model.Tests
{
    ...
    public class ContractFunctionTests
    {
        ...
        static IEnumerable<object[]> GenerateTestData()
        {
            ...
            var expectedWithModifierAndReturns = $"function {name1}({parametersCode2}) {visibility4.GenerateCode()} {m1Name}() returns ({returningType1.GenerateCode(true)}) {{\n}}";
            ...
            var expectedWithModifierAndReturns2 = $"function {name1}({parametersCode2}) {visibility4.GenerateCode()} {m2Name}() returns ({returningType1.GenerateCode(true)}) {{\n}}";
            ...
            var expectedWithModifierAndReturnsAndEmptyParamList = $"function {name1}({parametersCode2}) {visibility4.GenerateCode()} {m2Name}({parametersCode1}) returns ({returningType1.GenerateCode(true)}) {{\n}}";
            ...
            var expectedWithModifierAndReturnsAndEmptyParamList2 = $"function {name1}({parametersCode2}) {visibility4.GenerateCode()} {m2Name}({parametersCode2}) returns ({returningType2.GenerateCode(true)}) {{\n}}";
            ...
            var expectedWithModifierAndReturnsAndParamList = $"function {name1}({parametersCode2}) {visibility4.GenerateCode()} {m2Name}({parametersCode1}) returns ({returningType2.GenerateCode(true)}) {{\n}}";
            ...
            var expectedWithModifierAndReturnsAndParamList2 = $"function {name1}({parametersCode2}) {visibility4.GenerateCode()} {m2Name}({parametersCode2}) returns ({returningType2.GenerateCode(true)}) {{\n}}";
            ...
            var expectedWithModifierAndReturnsAndViewAndParamList2 = $"function {name1}({parametersCode2}) {visibility4.GenerateCode()} {m2Name}({parametersCode2}) {ModificationType.View.GenerateCode()} returns ({returningType2.GenerateCode(true)}) {{\n}}";
            ...
            var expectedWithModifierAndReturnsAndViewAndParamList2Payable = $"function {name1}({parametersCode2}) {visibility4.GenerateCode()} {m2Name}({parametersCode2}) payable returns ({returningType2.GenerateCode(true)}) {{\n}}";
